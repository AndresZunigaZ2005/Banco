package uniquindio.programacion1.parqueadero.view;
...
{
	private JLabel titulo, nombre, contenedorNombre, telefono, contenedorTelefono, placa, contenedorPlaca, modelo, contenedorModelo;
	...
	public EliminarVehiculo(int guardaI, int guardaJ, GenerarMatrizBotones miVentanaBotones, VentanaPrincipal  miVentanaPrincipal)
	{
