package uniquindio.programacion1.parqueadero.model;
...
import uniquindio.programacion1.parqueadero.view.GenerarMatrizBotones;
import uniquindio.programacion1.parqueadero.view.VentanaPrincipal;
/**
 ...
 */
 ...
 {//retorna -1 si la posicion no está en el arreglo, de lo contrario la posición i dentro del arraylist donde está
 int posicion=-1;
...
return posicion;
 ...
 {   //aquí se invoca a verificarEstaPosicion
...
/**
 * Haga un método que, devuelva un listado sin repeticiones y ordenado con
 *  todos los propietarios que han estado en el parqueadero y que han 
 *  repetido en mínimo  2 puestos (1.2). Ejemplo Pedro se ha parqueado en
(0,0) (0,2) (0,0) (1,1) (0,4) (2,3) (4,1) (1,1). Pedro se agrega al listado porque repitió en el
 puesto (0,0) y en el puesto (1,1,). 
 Luis se ha parqueado en (2,0) (0,2) (0,0) (1,3) (0,4) (2,3) (4,1) (1,1), no repitió en mínimo 2 puestos por lo que no podrá ser agregado al arraylist.
 */
...
/*
 Básese en este método para construir el método anterior
